...
import { REGISTER_MUTATION } from '../apollo/user/mutation';
import { useAuthStore } from '../apollo/store';
import { useRedirectIfAuthed } from '../libs/hooks/useAuth';
        ...
        <Box width="100%" maxWidth={480}>
          <Box textAlign="center" mb={4}>
            ...
            <Typography
              variant="h5"
              fontWeight={800}
              sx={{ background: 'linear-gradient(135deg, #FD6511, #D94E05)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
            >
              Vivora
            </Typography>
