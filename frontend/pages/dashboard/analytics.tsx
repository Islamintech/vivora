...
import { ANALYTICS_QUERY } from '../../apollo/user/query';
              ...
              sx={{
                ...
                '& .MuiToggleButtonGroup-grouped': {
                  ...
                  '&.Mui-selected': {
                    ...
                    boxShadow: '0 2px 8px rgba(253,101,17,0.35)',
                            ...
                            <Box sx={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%', justifyContent: 'flex-end', cursor: 'default' }}>
                              ...
                              <Box
                                sx={{
                                  ...
                                  bgcolor: isBest ? '#B03D02' : 'rgba(253,101,17,0.55)',
                              ...
                              >
                                <Box
                                  sx={{
                                    ...
                                    borderColor: isBest ? '#B03D02' : isToday ? 'primary.main' : 'divider',
                                    bgcolor: heat > 0 ? `rgba(253,101,17,${0.05 + heat * 0.22})` : 'transparent',
                                ...
                                >
                                  ...
                                  <Typography variant="caption" sx={{ fontSize: '0.6rem', fontWeight: isBest ? 700 : 600, color: day.revenue > 0 ? '#B03D02' : 'text.disabled', display: 'block' }}>
                      ...
                      <Box key={item.menuItemId}>
                        ...
                        <LinearProgress
                          ...
                          sx={{
                            ...
                            '& .MuiLinearProgress-bar': { borderRadius: 1, transition: `transform .5s ease-out ${i * 60}ms`, bgcolor: i === 0 ? '#B03D02' : 'rgba(253,101,17,0.55)' },
                          }}
                        />
                      </Box>
                    ))}
