...
import { ADMIN_TOGGLE_RESTAURANT_MUTATION, APPROVE_RESTAURANT_MUTATION, REJECT_RESTAURANT_MUTATION, PURGE_ERROR_LOGS_MUTATION, ADMIN_TOGGLE_USER_MUTATION, ADMIN_RESET_USER_PASSWORD_MUTATION, GENERATE_INVOICES_MUTATION, CONFIRM_INVOICE_PAID_MUTATION } from '../../apollo/admin/mutation';
import { PLATFORM_STATS_QUERY, ADMIN_RESTAURANTS_QUERY, ERROR_LOGS_QUERY, ALL_ORDERS_QUERY, PENDING_RESTAURANTS_QUERY, ADMIN_USERS_QUERY, ADMIN_RESTAURANT_DETAIL_QUERY, PLATFORM_TIMESERIES_QUERY, ALL_INVOICES_QUERY } from '../../apollo/admin/query';
import { useRequireAuth } from '../../libs/hooks/useAuth';
import { useAuthStore } from '../../apollo/store';
import { statusColor, OrderStatus, RestaurantStatus } from '../../libs/types';
import { formatMoney } from '../../libs/money';
import PlatformTrends from '../../libs/components/admin/PlatformTrends';
