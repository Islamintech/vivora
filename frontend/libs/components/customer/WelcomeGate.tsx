    ...
    return (
      <ButtonBase
        ...
        sx={{
          ...
          boxShadow: active ? '0 12px 28px rgba(253,101,17,0.35)' : '0 2px 10px rgba(0,0,0,0.05)',
            ...
            return (
              <ButtonBase
                ...
                sx={{
                  ...
                  boxShadow: selected ? '0 6px 18px rgba(253,101,17,0.2)' : '0 2px 10px rgba(0,0,0,0.05)',
