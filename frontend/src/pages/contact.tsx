            ...
            <Stack spacing={2}>
              {channels.map((ch) => (
                <Stack
                  ...
                  sx={{ bgcolor: '#fff', borderRadius: '1.25rem', p: 2.5, border: '1px solid rgba(140,113,100,0.14)', textDecoration: 'none', cursor: 'pointer', transition: 'transform .25s, box-shadow .25s', '&:hover': { transform: 'translateY(-3px)', boxShadow: '0 12px 28px rgba(157,67,0,0.1)' } }}
                >
                  <Box sx={{ width: 48, height: 48, borderRadius: 2.5, bgcolor: 'rgba(249,115,22,0.1)', border: '1px solid rgba(157,67,0,0.18)', color: PRIMARY, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{ch.icon}</Box>
                  <Box>
              ...
              <Box sx={{ bgcolor: SC_LOW, borderRadius: '1.25rem', p: 2.5, border: '1px solid rgba(140,113,100,0.14)' }}>
                <Stack direction="row" spacing={1} alignItems="center" mb={1.5}>
                  ...
                  <Typography sx={{ fontSize: 13, fontWeight: 800, color: PRIMARY, letterSpacing: '0.08em', textTransform: 'uppercase' }}>{c.quickTitle}</Typography>
                </Stack>
                <Stack spacing={1.75}>
